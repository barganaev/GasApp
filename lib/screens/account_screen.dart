    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          //     Navigator.of(context).popUntil((route) => route.isFirst);
          //   },
          //   child: Text('Выход', style: TextStyle(color: Color(0xFF016fbe)),),
          // ),
            ...
            return Column(
              children: [
                Container(
                  ...
                  //     child: Image.asset('assets/logo_blue.png', height: screenSize(context).height * 0.07,),
                  //   ),
                  //     title: Column(
                  //     children: [
                  ...
                  //       Text('+77012345678', style: TextStyle(fontSize: 12),),
                  //       Text('E-mail: umirbek@gmail.com', style: TextStyle(fontSize: 12),),
                  //     ],
                  //   ),
                  ...
                  child: IntrinsicHeight(
                    child: Container(
                      // padding: EdgeInsets.only(top: screenSize(context).height * 0.01),
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Padding(
                                padding: EdgeInsets.only(left: screenSize(context).width * 0.05, right: screenSize(context).width * 0.05),
                                child: CircleAvatar(
                                  radius: 32,
                                  backgroundColor: Colors.grey[300],
                                  child: Image.asset('assets/logo_blue.png', height: screenSize(context).height * 0.08,),
                                ),
                              ),
                              // Image.asset('assets/logo_blue.png', height: screenSize(context).height * 0.08,),
                              Padding(
                          ...
                          Padding(
                            padding: EdgeInsets.only(top: screenSize(context).height * 0.05, right: screenSize(context).width * 0.03),
                            child: IconButton(
                              icon: Icon(
                                Icons.settings
                              ),
                              onPressed: (){
                                showDialog(
                                    ...
                                    builder: (_) =>
                                        Container(
                                          margin: EdgeInsets.only(top: screenSize(context).height * 0.25, left: screenSize(context).width * 0.2, right: screenSize(context).width * 0.1, bottom: screenSize(context).height * 0.48),
                                            ...
                                            children: [
                                              Expanded(
                                                child: Center(
                                                  child: Padding(
                                                    ...
                                                    child: Container(
                                                      child: Text(
                                                        'Вы действительно хотите закрыть аккаунт и выйти из личного кабинета?', style: TextStyle(fontWeight: FontWeight.bold),
                                                      )
                                                    ),
                                                  )
                                                )
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Expanded(
                                                    child: Container(
                                                        padding: EdgeInsets.only(right: screenSize(context).width * 0.05),
                                                      child: TextButton(
                                                        style: ButtonStyle(
                                                            backgroundColor: MaterialStateProperty.all<Color>(Color(0xFF016fbe)),
                                                            shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                                                                RoundedRectangleBorder(
                                                                    borderRadius: BorderRadius.circular(10)
                                                                )
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF016fbe), fontSize: 17),
                            ),
                          ),
                        ),
                        SizedBox(
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                width: screenSize(context).width * 0.5, // TODO: Crash is here!
                                                  padding: EdgeInsets.only(
                                                      left: screenSize(context).width * 0.03),
                                                  child: Text(
                                                      'Открыть или закрыть объект', style: TextStyle(fontSize: screenSize(context).width * 0.034),)),
                                              Padding(
                                                padding: EdgeInsets.only(
