          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                color: Colors.amber,
                // child: RegistrationText1(
                //     h1: AppLocalizations.of(context).translate('login'),
                //     p: AppLocalizations.of(context).translate('login-subtext')),
              ),
              Container(
                        ...
                        children: <Widget>[
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                errorStyle: TextStyle(color: Color(0xFFE04146)),
                                labelText: "login",
